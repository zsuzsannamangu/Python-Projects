...
#Create class called UniversityClasses w/ 4 attributes:
class UniversityClasses(models.Model):
    ...
    Django will automatically append the letter ‘s’ to any model name meaning 
    the UniversityClasses model would be displayed as UniversityClassess. 
    verbose_name_plural allows you to set the exact text you would like displayed 
    in the browser and removes the plural form of the model name. 
    """
